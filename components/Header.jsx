  ...
  return (
    <>
      <div className="header flex justify-between p-4 items-center bg-white">
        ...
        {search && (
          <div className="h-screen w-screen fixed top-0 left-0 backdrop-blur-xl p-6">
            {" "}
            <div>
              {" "}
              <div className="w-full border relative border-gray-200 rounded-lg bg-white ">
                {" "}
                <div>
                  <input
                    value={query}
                    ...
                    className="p-3 px-12 w-full rounded-lg "
                    type="text"
                  />
                </div>{" "}
                <div className="absolute top-3 -left-1 translate-x-1/2 pr-1 border-r-1 border-gray-300">
                  {" "}
                  <svg
                ...
                {filtered.length > 0 ? (
                  filtered.map((b) => {
                    ...
                    const imageBlock = b.blocks.find(
                      (bl) => bl.type === "coverImage"
                    );
                    return (
                      <div
                        key={b._id}
                  ...
                  <div className="w-full p-4 border-gray-300 text-center">
                    {" "}
                    <div className="text-gray-600 ">Nothing found</div>{" "}
                  </div>
                )}{" "}
                <div className="flex items-center justify-center pb-4">
                  ...
                  <div
                    ...
                    className="bg-gray-600 text-white p-2 px-4 rounded-lg pointer"
                  >
                    Close search
                  </div>{" "}
                </div>{" "}
